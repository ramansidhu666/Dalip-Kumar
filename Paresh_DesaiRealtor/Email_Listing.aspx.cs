    ...
    public partial class Email_Listing : System.Web.UI.Page
    {
        ...
        public string GetPropertyDetails()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                html.AppendLine("<h2 style='font-weight:bold; font-size:16px;'>Dalip Kumar for Property ID  " + dt.Rows[0]["MLS"].ToString() + ";</h2>");
                html.AppendLine("<h2 style='font-weight: bold; font-size: 16px;'>Message Received From:</h2>");
                html.AppendLine("<p style='float: left; margin: 0 40px 0 0;'>Phone Number:</p><span style='float:left;'>416-459-1558</span><br/>");
                ...
                html.AppendLine("<p>http://kumardaliprealtor.com///</p>");
                ...
                //html.AppendLine("23 Westmore Drive, Toronto, Ontario, M9V 3Y7<br/>Property ID: " + dt.Rows[0]["MLS"].ToString() + "</h2>");
                html.AppendLine("</div>");
                ...
                html.AppendLine("<p>For more information visit <a href='#'>http://kumardaliprealtor.com//</a> </p></div>");
                html.AppendLine("<div style='float:left; padding-left:12px;'>");
                html.AppendLine("<p style='margin:0px;'>Listed By</p><br/><p>Dalip Kumar<br/>Broker</p>");
                ...
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Cell::</p><span style='float:left;'>416-459-1558</span><br/>'");
                ...
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Website:</p><span style='float:left;'>>http://kumardaliprealtor.com///</span><br/></div></div>");
                html.AppendLine("<div style='float:left; width:100%;'>");
