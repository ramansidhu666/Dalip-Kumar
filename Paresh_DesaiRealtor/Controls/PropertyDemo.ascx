 ...
 <script>
     ...
     $(document).ready(function () {
         $("#shareBtn").click(function () {
             ...
             var URL = 'http://kumardaliprealtor.com//PropertyDetails.aspx?MLSID=' + MLSID + '&PropertyType=' + PropertyType;
            ...
            <div class="col-md-12 col-sm-12">
              ...
              <img src="../images/arshad.png" alt="" />
                        ...
                        <div class="roco_pro_info">
                            <h2>
                            <asp:Label ID="lblname"  runat="server"></asp:Label>Dalip Kumar</h2>
                            <p>Broker</p>
                            <asp:Label CssClass="email_profile_r" ID="lblemail" runat="server"></asp:Label>
                            <span class="email_profile_r">416-459-1558</span>
                        </div>
                    </div>
